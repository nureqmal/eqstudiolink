// Shared line-icon system (Feather-style: 24x24 viewbox, single stroke, currentColor).
// Replaces emoji-as-icon usage throughout the app — emoji render inconsistently
// across OS/browsers and can't be color-matched to the theme; these can.
const ICON_PATHS = {
  ...
  sparkles: '<path d="M12 3v4M12 17v4M5 5l2.5 2.5M16.5 16.5 19 19M3 12h4M17 12h4M5 19l2.5-2.5M16.5 7.5 19 5"></path>',
};

export function icon(name, size = 20, extraAttrs = "") {
  const d = ICON_PATHS[name] || "";
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0; vertical-align:-3px;" ${extraAttrs}>${d}</svg>`;
}
